...
![Ubuntu Environment](screenshots/01-ubuntu-apache-environment.png)
*(Shows the active Ubuntu Linux terminal interface alongside the successful Apache2 default web server landing page).*
...
* **Screenshot Reference:**
![SLA Policies Configuration](screenshots/03-sla-policies-config.png)
*(Shows the live configuration panel of the active SLA plans inside the system).*
...
* **Screenshot Reference:**
![Scenario 1 Ticket Received](screenshots/04-scenario1-ticket-received.png)
...
* **Screenshot Reference:**
![Scenario 1 Resolution](screenshots/05-scenario1-active-directory-resolution.png)
...
* **Screenshot Reference:**
![Scenario 2 Diagnostics](screenshots/06-scenario2-helpdesk-diagnostic.png)
*(Shows the ticket thread where IT Agent Fahad investigated the workstation and left a technical note stating that local networking is fine, but perimeter Firewall rules are blocking the developer's external ports).*
...
* **Screenshot Reference:**
![Scenario 2 NOC Resolution](screenshots/07-scenario2-noc-firewall-resolution.png)
*(Shows the complete historical log of the ticket being transferred to NOC and successfully resolved).*
...
3. **Cross-Department Collaboration:** Practiced how real-world departments escalate complex issue to the specific department capable of resolving them.
